...
from interface.python_ui.analisys_diseases_ui import Ui_analysis_deseases_Window
class AnalisysDiseasesWindow(QtWidgets.QMainWindow, Ui_analysis_deseases_Window):
    def __init__(self):
        super().__init__()
        self.mydir_weight = ""
        self.mydir_img = ""
    ...
    def changeEvent(self, event):
        ...
        super(AnalisysDiseasesWindow, self).changeEvent(event)
    ...
    def on_click_start(self):
        subprocess.run(
            ['python', '../dummy neural network/neural_network.py', self.mydir_weight, self.mydir_img, self.mydir_save])
