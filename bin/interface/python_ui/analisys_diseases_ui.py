...
# Form implementation generated from reading ui file 'analisys_diseases.ui'
#
...
class Ui_analysis_deseases_Window(object):
    def setupUi(self, analysis_deseases_Window):
        analysis_deseases_Window.setObjectName("analysis_deseases_Window")
        analysis_deseases_Window.resize(713, 180)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icon/interface/imges/icon.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        analysis_deseases_Window.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(analysis_deseases_Window)
        ...
        analysis_deseases_Window.setCentralWidget(self.centralwidget)

        self.retranslateUi(analysis_deseases_Window)
        QtCore.QMetaObject.connectSlotsByName(analysis_deseases_Window)

    def retranslateUi(self, analysis_deseases_Window):
        _translate = QtCore.QCoreApplication.translate
        analysis_deseases_Window.setWindowTitle(_translate("analysis_deseases_Window", "Analysis of auto discovery results"))
        self.Title.setText(_translate("analysis_deseases_Window", "Automatic search for diseases"))
        self.button_weight.setText(_translate("analysis_deseases_Window", "..."))
        self.path_weight_text.setText(_translate("analysis_deseases_Window", "Choose the path to the file with weights artificial neural network"))
        self.button_images.setText(_translate("analysis_deseases_Window", "..."))
        self.path_directiry_img.setText(_translate("analysis_deseases_Window", "Select the path to the input files directory"))
        self.path_directiry_save.setText(_translate("analysis_deseases_Window", "Select path to output directory"))
        self.button_generation.setText(_translate("analysis_deseases_Window", "Start"))
        self.pushButton.setText(_translate("analysis_deseases_Window", "Back to main menu"))
import foto_rc
